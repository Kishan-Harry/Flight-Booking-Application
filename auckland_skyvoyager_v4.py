...
#***********TO RUN THIS PROGRAM YOU MUST INSTALL THE PANDAS LIBRARY - type in 'pip install pandas' inside the terminal*************
import pandas as pd
        ...
        if len(fn[0])==0 or len(ln[0])==0 or len(em[0])==0 or len(p[0])==0 or len(a[0])==0:
            ...
            try:
                ...
                while validation == True:
                    ...
                    try:
                        with open("accounts.csv", mode="a+") as file:
                            file.seek(0)
                        ...
                        msg="No existing accounts found. Proceeding with this email address."
                    ...
                    #Asks the user for their age then compares with boundary case
                        ...
                        with open("accounts.csv", mode="a+", newline="") as csvfile:
                            ...
                            writer.writerow({"username": username, "email":email, 
                                            "password":password, "user data":empty_json_string})
